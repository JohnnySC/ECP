...
class ProvideViewModelChainTest {
    ...
    fun `test creation of ViewModelChain creation`()
    {
        ...
        val result=ProvideViewModelChain.Base(provideViewModelChainTestOne,provideViewModelChainTestTwo,provideViewModelChainTestThree).viewModelChain() as ViewModelChainTest
    ...
    private open class ViewModelChainTest(featureChain: FeatureChain.CheckAndHandle):ViewModelChain(featureChain)
    {
    ...
    private class ProvideViewModelChainTest(private val viewModelChain: ViewModelChainTest) : ProvideViewModelChain<ViewModelChainTest> {
        override fun viewModelChain() = viewModelChain
    }



    private class ViewModelChainBaseTest(nextFeatureChain: FeatureChain.CheckAndHandle) : ViewModelChainTest(nextFeatureChain)
    {
